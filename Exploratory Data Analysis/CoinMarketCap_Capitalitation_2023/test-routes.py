...
# Ruta del proyecto
project_root = os.path.join(os.getcwd(), "/home/ana/Documentos/EDA_ML_PROJECTS/EDA/CoinMarketCap_Capitalitation_2023")
...
ruta_no_deseada = "EDA/CoinMarketCap_Capitalitation_2023/dataSet"
